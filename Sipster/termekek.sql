...
(4, 'Bloody Brain', '2 cl Őszibarack Likőr, 2 cl Baileys, 2 cl Grenadine szirup', 3200, 'Bloody Brain.jpg'),
(5, 'Bloody Mary', '4.5 cl Vodka, 9 cl Paradicsomlé, 1.5 cl Citromlé, csipet Só + Bors, pár csepp Worcestershire, pár csepp Tabasco', 3800, 'BloodyMary.jpg'),
(6, 'Boxcar', '4 cl Száraz Gin, 1 cl CointreauLimelé, 1 cl Tojásfehérje', 3900, 'Boxcar.jpg'),
(7, 'Lamborghini', '3 cl Sambucan, 3 cl kávélikőr (pl. Kahlúa), 3 cl Baileys, 3 cl Blue Curaçaon', 3500, 'Lamborghini.jpg'),
...
(14, 'Brandy Alexander', '2 cl Brandy, 2 cl Créme De Cacao Brown, 2 cl Tejszín', 4200, 'BrandyAlexander.jpg'),
...
(28, 'Forralt bor (4f)', '0.75 l száraz vörösbor, 70 g cukor, 2 rúd fahéj, 8 szem szegfűszeg, 2 szem szegfűbors, 4 szelet citrom', 2800, 'Forralt bor.jpg'),
...
(35, 'Jager Grog (5f)', '2 dl Jägermeister, 2 db narancs leve, 1 zacskó vaníliás cukor, 5 dl fekete tea, 1 db fahéj rúd', 3600, 'jager-grog.jpg'),
...
(38, 'Long Island Ice Tea', '1.5 cl Vodka, 1.5 cl Tequila, 1.5 cl Fehér rum, 1.5 cl Cointreau, 1.5 cl Gin, 2.5 cl Citromlé, 3 cl Cukorszirup, 1 dl Cola', 4000, 'LongIslandIceTea.jpg'),
...
(41, 'Manhattan', '5 cl Bourbon / Rye Whiskey, 2 cl Vermuth rosso, csepp Angostura bitter ', 4500, 'Manhattan.jpg'),
...
(49, 'Pentecostal', '4.5 cl Bourbon whiskey, 4.5 cl Vodka, 17.5 cl Sprite / Szóda  ', 4100, 'Pentecostal.jpg'),
(50, 'Pink Cadillac', '3 cl Vodka Amaretto, 1 cl Eperszirup, 2 cl Citromlé', 3800, 'PinkCadillac.jpg'),
